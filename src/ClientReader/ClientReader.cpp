...
int ClientReader::worker(){
    ...
    try {
        ...
        cout << "Something went wrong while reading the input file: " << e.what() << endl;
    }
    ...
    try {
        ...
        // Handle and report the exception
        cout << "Error occured while attempting to close the file: " << e.what() << endl;
    ...
    try {
        initialState = getFirstItemValue(stateMap);
    } catch (const exception& e) {
        // Handle and report the exception
        cout << "Error occured while getting the initial state of the machine: " << e.what() << endl;
        //return 1; // Return error
    }
    ...
    try {
        ...
        // Handle and report the exception
        cout << "Error occured while setting the attributes of the machine: " << e.what() << endl;
    }
    ...
    try {
        ...
        // Handle and report the exception
        cout << "Error occured while the machind is executing: " << e.what() << endl;
    }
}
